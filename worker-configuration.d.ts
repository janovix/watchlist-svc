/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bd8a59ef8b730b893ffe50bce787ea87)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		THREAD_SVC: Service /* entrypoint ThreadSvcEntrypoint from thread-svc */;
		AML_SERVICE: Service /* entrypoint AmlSvcEntrypoint from aml-svc */;
		FLAGS_SERVICE: Service /* entrypoint FlagsSvcEntrypoint from flags-svc */;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "TRUSTED_ORIGINS" | "AUTH_JWKS_CACHE_TTL" | "CACHE_ENABLED" | "PEP_SEARCH_ENABLED" | "PEP_GROK_ENABLED" | "ADVERSE_MEDIA_ENABLED" | "R2_BUCKET_NAME" | "GROK_API_KEY">> {}
}
