...
// Serve consolidated OpenAPI spec (aml-svc style) - register before fromHono so it wins
app.get("/openapi.json", (c) => c.json(openAPISpec));

// Setup OpenAPI registry for route handlers (chanfana OpenAPIRoute classes)
...
// Mount upload routes (for file uploads to R2) - documented in openapi.ts
